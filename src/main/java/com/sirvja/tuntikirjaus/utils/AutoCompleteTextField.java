...
public class AutoCompleteTextField<S> extends TextField {
     ...
     */
    private String textOccurenceStyle = "-fx-font-weight: bold; -fx-fill: #00ff00;";
    private String otherTextStyle = "-fx-font-weight: bold; -fx-fill: #00ff00;";
    ...
    public ObjectProperty<S> getLastSelectedObject() {
