...
public class TuntikirjausServiceTest {
    ...
    void testSavingTuntikirjaus() {
        ...
        TuntiKirjaus tuntiKirjausWithId = new TuntiKirjaus(lastTuntikirjaus.getId() + 1, tuntiKirjaus.getStartTime(), tuntiKirjaus.getEndTime().orElse(null), tuntiKirjaus.getTopic(), tuntiKirjaus.isRemote());
